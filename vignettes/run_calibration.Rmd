...
devtools::load_all()
#install needed dependencies, run once
...
Creates run directories based on Google sheet runs, modifies the biology PRM file and run file to update run time based on the Google sheet prm.modify. Will also modify pprey

```{r read prm changes, include=FALSE}

lapply(runs.modify, modify_prm, sheet.id, sheet.name, run.dir, prm.modify, prm.name, atlantis.run, base.path)
...
```{r compare files}
old.file <- "/nfsdata/ampscalibration/Run_mv1_v6718_73d_1/AMPSbioparam_mv1_2024_V7.prm"
new.file <- "/nfsdata/ampscalibration/Run_mv1_v6718_146d_3/AMPSbioparam_mv1_2024_V7.prm"

diffr::diffr(old.file, new.file)


old.file <- "~/psatlantismodel/Atlantis_mv1_base_2024_5yrs_V2/AMPSbioparam_mv1_2024_V6.prm"
new.file <- "~/psatlantismodel/Atlantis_mv1_base_2024_5yrs_V2/AMPSbioparam_mv1_2024_V7.prm"
